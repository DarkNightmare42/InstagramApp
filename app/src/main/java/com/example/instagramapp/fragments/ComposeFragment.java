...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        selectBtn = view.findViewById(R.id.uploadBtn);
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(description.isEmpty()){
                    Toast.makeText(getContext(), "Whoops, looks like you forgot something", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(photoFile == null || postImage.getDrawable() == null){
                    Toast.makeText(getContext(), "Whoops, no image selected", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e != null){
                    ...
                    Toast.makeText(getContext(), "Whoops, looks like there's a problem posting", Toast.LENGTH_SHORT).show();
                }
    ...
    private void launchCamera() {
        Toast.makeText(getContext(), "launch camera method", Toast.LENGTH_SHORT).show();
